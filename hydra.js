...
const patches = {
    ...
    ,5: () => {
        s0.initCam(currentCam +1 % cameras.length)
        s1.initCam(currentCam)
...
export { initHydra, reloadActiveSource, reloadPatch, resizeHydraPatch, toggleResolution, patches, switchCam };